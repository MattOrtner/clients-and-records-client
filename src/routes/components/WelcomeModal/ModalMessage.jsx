  ...
  return (
    <div className=" bg-gray-100 p-4 rounded-md shadow-md overflow-auto">
      ...
      <p className="text-gray-700 font-sans">
        ...
        <br />
        I have a therapist friend that wanted to seperate her work life from her
        phone. Remove clients from her contacts, remove all the jumbled notes
        out of her default phone app, and get organized. So I got to work!
        <br />
        The user can create, read, update, and delete new clients, each client's
        sessions (while keeping their notes and info all together), and track
        payments. Additionally, users can track payments. This is a work in
        ...
        field. The <b>password</b> is just a copy of the full email... very very
        sneaky.
        <br />
